...
(function (window, undefined) {
  ...
  var ceil = Math.ceil,
    ...
    floor = Math.floor,
    getPrototypeOf =
      reNative.test((getPrototypeOf = Object.getPrototypeOf)) && getPrototypeOf,
  ...
  var hasObjectSpliceBug =
    ((hasObjectSpliceBug = { "0": 1, length: 1 }),
    arrayRef.splice.call(hasObjectSpliceBug, 0, 1),
    hasObjectSpliceBug[0]);
  ...
  try {
    var noNodeClass =
      toString.call(document) == objectClass && !({ toString: 0 } + "");
  } catch (e) {}

  /** Used to identify object classifications that `_.clone` supports */
  var cloneableClasses = {};
  cloneableClasses[funcClass] = false;
  cloneableClasses[argsClass] = cloneableClasses[arrayClass] = cloneableClasses[
    boolClass
  ] = cloneableClasses[dateClass] = cloneableClasses[
    numberClass
  ] = cloneableClasses[objectClass] = cloneableClasses[
    regexpClass
  ...
  function cachedContains(array, fromIndex, largeSize) {
    ...
    if (isLarge) {
      ...
      while (++index < length) {
        ...
        var key = array[index] + "";
        (hasOwnProperty.call(cache, key) ? cache[key] : (cache[key] = [])).push(
          array[index]
        );
      }
    }
    return function (value) {
      if (isLarge) {
        var key = value + "";
        return (
          hasOwnProperty.call(cache, key) && indexOf(cache[key], value) > -1
        );
      }
    ...
    function bound() {
      ...
      if (partialArgs.length) {
        args = args.length
          ? ((args = slice(args)),
            rightIndicator
              ? args.concat(partialArgs)
              : partialArgs.concat(args))
          : partialArgs;
      }
  ...
  var isArray =
    ...
    function (value) {
      ...
      return (
        (argsAreObjects && value instanceof Array) ||
  ...
  var keys = !nativeKeys
    ...
    : function (object) {
        ...
        if (
          (hasEnumPrototype && typeof object == "function") ||
  ...
  function shimIsPlainObject(value) {
    ...
    if (
      (!isFunction(ctor) && (!noNodeClass || !isNode(value))) ||
  ...
  function isEqual(a, b, callback, thisArg, stackA, stackB) {
    ...
    if (callback && !whereIndicator) {
      callback =
        typeof thisArg == "undefined"
          ? callback
          : createCallback(callback, thisArg, 2);
    ...
    if (isArr) {
      ...
      while (size--) {
        ...
        if (whereIndicator) {
          ...
          !(result = isEqual(a[size], value, callback, thisArg, stackA, stackB))
        ) {
          break;
        }
      }
    ...
    forIn(b, function (value, key, b) {
      if (hasOwnProperty.call(b, key)) {
        ...
        return (result =
          ...
          isEqual(a[key], value, callback, thisArg, stackA, stackB));
      }
    });
  ...
  var isPlainObject = !getPrototypeOf
    ...
    : function (value) {
        ...
        return objProto
          ? value == objProto ||
              (getPrototypeOf(value) == objProto && !isArguments(value))
  ...
  function merge(object, source, deepIndicator) {
    ...
    while (++index < length) {
      (isArray(args[index]) ? forEach : forOwn)(args[index], function (
        source,
        key
      ) {
        var found,
  ...
  function contains(collection, target, fromIndex) {
    ...
    fromIndex =
      (fromIndex < 0 ? nativeMax(0, length + fromIndex) : fromIndex) || 0;
  ...
  function indexOf(array, value, fromIndex) {
    ...
    if (typeof fromIndex == "number") {
      index =
        (fromIndex < 0 ? nativeMax(0, length + fromIndex) : fromIndex || 0) - 1;
    } else if (fromIndex) {
      ...
      if (inited || indexOf(seen, value) < 0) {
        ...
        while (--argsIndex) {
          if (
            !(
              cache[argsIndex] ||
              (cache[argsIndex] = cachedContains(args[argsIndex], 0, 100))
            )(value)
          ) {
            continue outer;
          }
  ...
  function memoize(func, resolver) {
    ...
    return function () {
      var key =
        (resolver ? resolver.apply(this, arguments) : arguments[0]) + "";
  ...
  function template(text, data, options) {
    ...
    try {
      var result = Function(importsKeys, "return " + source + sourceURL).apply(
        undefined,
        importsValues
      );
    } catch (e) {
