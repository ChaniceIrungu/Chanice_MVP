  ...
  [
    ...
    function (match, leadEscape, range, endEscape, close) {
      return leadEscape === ESCAPE // '\\[bar]' -> '\\\\[bar\\]'
        ? "\\["
            .concat(range)
            .concat(cleanRangeBackSlash(endEscape))
            .concat(close)
        : close === "]"
...
var checkPattern = function checkPattern(pattern) {
  return (
    pattern &&
    isString(pattern) &&
    !REGEX_TEST_BLANK_LINE.test(pattern) && // > A line starting with # serves as a comment.
    pattern.indexOf("#") !== 0
  );
};
  ...
  _createClass(Ignore, [
    ...
    },
    {
      ...
      value: function _test(originalPath, cache, checkUnignored, slices) {
        var path =
          originalPath && checkPath.convert(originalPath); // Supports nullable path
