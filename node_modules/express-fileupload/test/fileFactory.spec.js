...
describe('Test of the fileFactory factory', function () {
  ...
  describe('Properties', function () {
    ...
    it('contains the data property', () =>
      assert.ok(fileFactory(mockFileOpts).data));
    ...
    it('contains the md5 property', () =>
      assert.equal(fileFactory(mockFileOpts).md5, mockMd5));
    it('contains the mv method', () =>
      assert.equal(isFunc(fileFactory(mockFileOpts).mv), true));
  });
