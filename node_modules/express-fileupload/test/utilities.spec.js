...
describe('Test of the utilities functions', function () {
  ...
  describe('Test isFunc function', () => {
    it('isFunc returns true if function passed', () =>
      assert.equal(
        isFunc(() => {}),
        true
      ));
  ...
  describe('Test parseFileName function', () => {
    ...
    it('Strips away all non-alphanumeric chars when preserveExtension: true for a name without dots', () => {
    ...
    it('Returns correct filename if name contains dots characters and preserveExtension: true.', () => {
      const opts = { safeFileNames: true, preserveExtension: true };
