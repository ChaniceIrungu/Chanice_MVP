...
function Multipart(boy, cfg) {
  ...
  var i,
    ...
    fileopts =
      typeof cfg.fileHwm === "number" ? { highWaterMark: cfg.fileHwm } : {};
  ...
  var fieldSizeLimit =
      limits && typeof limits.fieldSize === "number"
        ? limits.fieldSize
        : 1 * 1024 * 1024,
    fileSizeLimit =
      limits && typeof limits.fileSize === "number"
        ? limits.fileSize
        : Infinity,
    filesLimit =
      limits && typeof limits.files === "number" ? limits.files : Infinity,
    fieldsLimit =
      limits && typeof limits.fields === "number" ? limits.fields : Infinity,
    partsLimit =
      limits && typeof limits.parts === "number" ? limits.parts : Infinity;
...
Multipart.prototype.write = function (chunk, cb) {
  var r;
  if ((r = this.parser.write(chunk)) && !this._pause) cb();
  else {
    this._needDrain = !r;
    this._cb = cb;
  }
